...
|                  MM              MM                  |       Ingeniería Civil Telemática
|               M                      M               |                  
...
|      M      $$$$$$$$$$$$$   $$$$$$$$$$$$$     $      |                 -Mi gato, que escribió código cuando deje el pc solo      
|            $$$$$$$$$$$$$$   $$$$$$$$$$$$$$     M     |
|     M        $$$$$$$$$$$$   $$$$$$$$$$$$        M    |       Fecha:  
|               $$$$$$$$$$$   $$$$$$$$$$               |
|    M     $$    $$$$$$$        $$$$$$$    $$$    M    |       Descripción general del programa: Este programa simula un tablero
|    M     $$$$   $$$$$          $$$$$$   $$$$    M    |                                         de conecta4, de dimensiones ajustables
|    M                                            M    |                                         hasta un máximo de 99x99 (si tiene una
|    M                                            M    |                                         pantalla lo suficientemente grande).
|    M     $$$M   $$$$$,         $$$$$$   $$$$    M    |                                         Intenté diseñarlo de tal forma que hacerle
|    M     $$    $$$$$$$4       $$$$$$$M    $$    M    |                                         cambios al juego resulte fácil:
|               $$$$$$$$$$$   $$$$$$$$$$M         M    |                                         se puede cambiar el símbolo el símbolo
|     M       0$$$$$$$$$$$$   $$$$$$$$$$$$$            |                                         de cada jugador, el símbolo de los
|            $$$$$$$$$$$$$$   $$$$$$$$$$$$$M           |                                         espacios sin ninguna jugada y las
|      M      $$$$$$$$$$$$     $$$$$$$$$$$$     M      |                                         dimensiones del tablero solo cambiando
|       M      $$$$$$$$           $$$$$$$      M       |                                         las respectivas variables
|        M       $$$$     $   $    $$$$$      M        |
|          M       $    $$$   $$$    $       M         | 
|           M          $$$$   $$$$         M           |
|             M                          M             |
...
const int largo = 7; 
const int ancho = 6;
int espaciosPorVerificar = 4; //Cantidad de espacios para ganar
